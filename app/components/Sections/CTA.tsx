      ...
      <div className="space-y-6">
        <div className="space-y-8">
          <div className="flex flex-col items-center gap-2">
            <h3 className="text-white font-semibold text-xl">Get Started</h3>
            <div className="w-6 h-0.5 bg-white" />
          </div>
          <h2 className="text-[39px] md:text-[49px] leading-[120%] tracking-[-0.5px] text-white font-bold text-center max-w-200">
